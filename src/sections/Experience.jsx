...
const experiences = [
  ...
  // },
  {
    ...
    duration: "2026",
    description:
      "Assisted in streamlining operational workflows through data analysis, cross-functional coordination, and automation support to improve efficiency and platform performance.",
  },
  {
    role: "AIML Intern",
    company: "ShadowFox",
    duration: "2025",
    description:
      "Worked on Python-based ML and NLP projects, including data preprocessing, model development, and integration with Flask and Tkinter user interfaces.",
  },
  {
    role: "AI and Full Stack Engineer Intern",
