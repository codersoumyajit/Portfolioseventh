...
const socials = [
  {
    Icon: FaLinkedinIn,
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/soumyajit-paul-072529250/",
  },
  {
    Icon: FaGithub,
    label: "GitHub",
    href: "https://github.com/codersoumyajit",
  },
  {
    Icon: FaFacebook,
    label: "Facebook",
    href: "https://www.facebook.com/soumyajit.paul.927/",
  },
  // {
  //   Icon: SiLeetcode,
  //   label: "Leetcode",
  //   href: "https://leetcode.com/u/RNV7oaPmZV/",
  // },
];
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        ...
        >
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            ...
            >
              I deliver data-driven, business-oriented solutions by leveraging
              Python, SQL, data analysis, and machine learning fundamentals in
              consulting and enterprise environments.
            </motion.p>
            ...
            >
              ...
              <a
                href="/SoumyajitPaul19_8_Final.pdf"
                download
